;(function () {
  ...
  var t = {
      1435: function (t, e, i) {
        ...
        const u = [
            ...
            },
            {
              path: '/index',
              name: 'index',
              component: () => Promise.all([i.e(385), i.e(826)]).then(i.bind(i, 8385)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile',
              name: 'mobile',
              component: () => Promise.all([i.e(385), i.e(149), i.e(8)]).then(i.bind(i, 4563)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            ...
            },
            {
              ...
              component: () => Promise.all([i.e(385), i.e(149), i.e(510)]).then(i.bind(i, 287)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              ...
              component: () => Promise.all([i.e(385), i.e(149), i.e(512)]).then(i.bind(i, 1560)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile/partner',
              name: 'MobilePartner',
              component: () => Promise.all([i.e(385), i.e(149), i.e(917)]).then(i.bind(i, 2423)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile/honour',
              name: 'MobileHonour',
              component: () => Promise.all([i.e(385), i.e(149), i.e(991)]).then(i.bind(i, 8969)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile/rescue',
              name: 'MobileRescue',
              component: () => Promise.all([i.e(385), i.e(149), i.e(834)]).then(i.bind(i, 7332)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile/contact',
              name: 'MobileContact',
              component: () => Promise.all([i.e(385), i.e(149), i.e(721)]).then(i.bind(i, 796)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              ...
              name: 'MobileNewsList',
              component: () => Promise.all([i.e(385), i.e(149), i.e(431)]).then(i.bind(i, 6763)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile/news',
              name: 'MobileNews',
              component: () => Promise.all([i.e(385), i.e(149), i.e(704)]).then(i.bind(i, 3878)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              ...
              component: () => Promise.all([i.e(385), i.e(149), i.e(104)]).then(i.bind(i, 9952)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
            {
              path: '/mobile/video',
              name: 'MobileVideo',
              component: () => Promise.all([i.e(385), i.e(149), i.e(25)]).then(i.bind(i, 2041)),
              meta: {
                title: '卡友卡车官网-中国物流运输卡车智能保障平台',
              },
            },
      ...
      4054: function (t, e, i) {
            ...
            if (0 == t.length) return e
            {
              ...
              for (let e = 0; e < t.length; e++)
                if (Array.isArray(i)) {
                  ...
                  if ('object' != typeof i || null === i || !(t[e] in i) || !n.anyTo(i)) return null
                  i = i[t[e]]
                }
              return i
            }
            ...
            if (t.length > 0) {
              ...
              if (Array.isArray(i))
                if (/^\d+$/.test(a)) {
                  ...
                  i.length > n ? (i[n] = this.findData(t, e, i[n])) : i.push(this.setData(t, e))
                } else i.push(this.setData(t, e))
              else
                'object' == typeof i &&
                  null !== i &&
                  n.anyTo(i) &&
                  (i[a] = a in i ? this.findData(t, e, i[a]) : this.setData(t, e))
            } else i = e
            return i
          }
          static setData(t, e) {
            ...
            if (t.length > 0) {
              ...
              if (Array.isArray(e)) {
                if (/^\d+$/.test(i)) {
                  ...
                  if (a < e.length) return 0 == t.length ? e.splice(a, 1) : (e[a] = this.removeData(t, e[a]) || e[a]), e
                }
              } else if ('object' == typeof e && null !== e && i in e && n.anyTo(e))
                return 0 == t.length ? delete e[i] : (e[i] = this.removeData(t, e[i]) || e[i]), e
            }
            return null
          }
        ...
        class s {
          ...
          set(t, e = null, i = 0) {
            if ((this.loadLibrary(), 'object' == typeof t)) {
              ;(i = 'number' == typeof e ? e : i), (i = 0 != i ? new Date().getTime() + 1e3 * i : 0)
          ...
          get(t, e) {
            if ((this.loadLibrary(), -1 != t.indexOf(':'))) throw new Error('不能完成跨域操作')
            {
              const i = t.split('.'),
                a = i.splice(0, 1)[0]
          ...
          has(t) {
            if (-1 != t.indexOf(':')) throw new Error('不能完成跨域操作')
            {
              ...
              if (i in this.library) {
                if (n.checkExpire(this.library[i].expire)) return null !== n.getData(e, this.library[i].data)
            ...
            if (-1 != t.indexOf(':')) throw new Error('不能完成跨域操作')
            {
              ...
              i in this.library[i] &&
                (n.checkExpire(this.library[i].expire) && 0 !== e.length
                  ? (this.library[i].data = n.removeData(e, this.library[i].data) || this.library[i].data)
        ...
        class r {
          ...
          scope(t) {
            return new s(
              ...
              (e) => {
                null === e ? delete this.library[t] : (this.library[t] = e), n.saveData(this.type, this.library)
              }
            )
          }
          set(t, e = null, i = 0) {
            ...
            if ('object' == typeof t) {
              ...
              s > 0 &&
                s < t.length - 1 &&
                ((a = t.replace(/^([^\\:]+)\\:.+$/, '$1')), (t = t.replace(/^[^\\:]+\\:(.+)$/, '$1')))
              const r = t.split('.'),
                o = r.splice(0, 1)[0]
              if ((a in this.library || (this.library[a] = {}), null === e)) throw new Error('非法的参数项')
          ...
          has(t) {
            ...
            if (
              (i > 0 &&
                i < t.length - 1 &&
                ((e = t.replace(/^([^\\:]+)\\:.+$/, '$1')), (t = t.replace(/^[^\\:]+\\:(.+)$/, '$1'))),
              e in this.library)
            ) {
              const i = t.split('.'),
                a = i.splice(0, 1)[0]
              if (a in this.library[e]) {
                if (n.checkExpire(this.library[e][a].expire)) return null !== n.getData(i, this.library[e][a].data)
            ...
            if (
              ...
              a in this.library[e] &&
                (n.checkExpire(this.library[e][a].expire) && 0 !== i.length
                  ? (this.library[e][a].data = n.removeData(i, this.library[e][a].data) || this.library[e][a].data)
          ...
          clear(t) {
            return (
              (t = t ?? 'default'),
              t in this.library && (delete this.library[t], n.saveData(this.type, this.library)),
              this
            )
          }
          clearAll() {
            return (this.library = {}), n.saveData(this.type, this.library), this
          }
          reload() {
        ...
        class o {
          static install(t) {
            ;(o.localCache = new r()), (o.sessionCache = new r(!1)), (t.config.globalProperties.cache = o.localCache)
          }
          static getCache(t = !0) {
            return 1 == t ? o.localCache : o.sessionCache
          }
        }
        ;(0, a.Z)(o, 'localCache', void 0), (0, a.Z)(o, 'sessionCache', void 0), (e['ZP'] = o.getCache)
      },
      1884: function (t, e, i) {
        i.d(e, {
          Z: function () {
        ...
        var o = i(6520),
          l = i(7139)
        const c = (t) => ((0, s.dD)('data-v-3a2a7437'), (t = t()), (0, s.Cn)(), t),
          d = ['data'],
          h = {
            class: 'MBAlertWindow',
          },
                    ...
                    ? ((0, s.wg)(),
                      (0, s.iD)(
                        'div',
                        {
                          key: 0,
                          class: 'MBAlertMark',
                          style: (0, l.j5)(void 0 !== t.dataLine.zindex ? 'z-index:' + t.dataLine.zindex : ''),
                          data: t.updateNum,
                        },
                        [
                          (0, s._)('div', h, [
                            void 0 !== t.dataLine.title
                              ? ((0, s.wg)(),
                                (0, s.iD)(
                                  ...
                                  {
                                    key: 0,
                                    class: (0, l.C_)(['MBAlertTitle', 'Color' + t.dataLine.status]),
                                  },
                                  [
                                    (0, s._)('span', null, (0, l.zw)(t.dataLine.title), 1),
                                    void 0 === t.dataLine.button
                                      ? ((0, s.wg)(),
                                        (0, s.iD)(
                                          ...
                                          {
                                            key: 0,
                                            onClick: e[0] || (e[0] = (...e) => t.close && t.close(...e)),
                                          },
                                          '×'
                                        ))
                                      : (0, s.kq)('', !0),
                            ...
                            (0, s._)(
                              'div',
                              {
                                class: (0, l.C_)([
                                  'MBAlertBody',
                                  void 0 === t.dataLine.title ? 'Color' + t.dataLine.status : '',
                                ]),
                                style: (0, l.j5)(
                                  (void 0 !== t.dataLine.width ? t.dataLine.width + 'px; ' : '') +
                                    (void 0 !== t.dataLine.height ? t.dataLine.height + 'px;' : '')
                                ),
                              },
                              [
                                (0, s._)(
                                  ...
                                  [
                                    (0, s._)(
                                      'span',
                                      {
                                        class: 'MBAlertBox',
                                        style: (0, l.j5)({
                                          textAlign: 'waiting' == t.dataLine.status ? 'center' : 'left',
                                        }),
                                      },
                                      [
                                        'waiting' === t.dataLine.status
                                          ? ((0, s.wg)(), (0, s.iD)('i', u, f))
                                          : (0, s.kq)('', !0),
                                        (0, s.Uk)(' ' + (0, l.zw)(t.dataLine.content || ''), 1),
                                      ],
                                      4
                                    ),
                                  ],
                              ...
                              ? ((0, s.wg)(),
                                (0, s.iD)('div', y, [
                                    ...
                                    (0, s.Ko)(
                                      ...
                                      (e, i) => (
                                        ...
                                        (0, s.iD)(
                                          ...
                                          {
                                            key: i,
                                            style: (0, l.j5)(void 0 !== e.color ? 'background:' + e.color : ''),
                                            class: (0, l.C_)(void 0 !== e.status ? 'Color' + e.status : ''),
                                  ...
                                  (0, s._)(
                                    ...
                                    {
                                      class: 'MBAlertCancel',
                                      onClick: e[1] || (e[1] = (...e) => t.close && t.close(...e)),
                                    },
        ...
        class m extends o.w3 {
          ...
          parseColor(t) {
            ...
            for (let o = 0; o < i.length; o++) i[o] < 0 ? (i[o] = 0) : i[o] > 255 && (i[o] = 255)
            const r = i[0].toString(16) + i[1].toString(16) + i[2].toString(16)
            return `--button-hover-color: #${r}; color: #${s}; background:#${t};`
          }
          clear() {
            1 == this.display ? (this.display = !1) : ((this.entity = void 0), (this.dataLine = void 0))
          }
          open(t) {
            ;(this.entity = t),
          ...
          update(t) {
            ...
            !0 === this.display && void 0 === this.entity && (this.display = !1),
        ...
        class A extends o.w3 {
          constructor(...t) {
            super(...t), (0, a.Z)(this, 'entity', []), (0, a.Z)(this, 'dataList', [])
          }
          update(t) {
            this.entity = t
            const e = []
                          ...
                          (0, s._)('div', _, [
                            void 0 !== t.dataLine.title
                              ? ((0, s.wg)(),
                                (0, s.iD)(
                                  ...
                                  {
                                    key: 0,
                                    class: (0, l.C_)(['MBTitle', 'Color' + t.dataLine.status]),
                                  },
                                  [
                                    (0, s._)('span', null, (0, l.zw)(t.dataLine.title.text), 1),
                                    t.dataLine.title.cancel ||
                                    (void 0 === t.dataLine.button && 'waiting' !== t.dataLine.status)
                                      ? ((0, s.wg)(),
                                        (0, s.iD)(
                                          'a',
                                          {
                                    ...
                                    t.dataLine.title.minmize
                                      ? ((0, s.wg)(),
                                        (0, s.iD)(
                                          ...
                                          {
                                            key: 1,
                                            onClick: e[1] || (e[1] = (...e) => t.mini && t.mini(...e)),
                                          },
                                          '–'
                                        ))
                                      : (0, s.kq)('', !0),
                            ...
                            (0, s._)(
                              'div',
                              {
                                class: 'MBBody',
                                style: (0, l.j5)(
                                  (void 0 !== t.dataLine.width ? 'width: ' + t.dataLine.width + 'px; ' : '') +
                                    (void 0 !== t.dataLine.height ? 'height: ' + t.dataLine.height + 'px; ' : '')
                                ),
                              },
                              [
                                (0, s._)(
                                    ...
                                    t.dataLine.bind && t.$options.components
                                      ? ((0, s.wg)(),
                                        (0, s.iD)('span', N, [
                                          ((0, s.wg)(),
                                          (0, s.j4)(
                                            (0, s.LL)(t.$options.components[t.dataLine.bind]),
                                            {
                                      ...
                                      : ((0, s.wg)(), (0, s.iD)('span', z, (0, l.zw)(t.dataLine.content), 1)),
                                  ],
                                  4
                                ),
                              ],
                              ...
                              ? ((0, s.wg)(),
                                (0, s.iD)('div', Z, [
                                    ...
                                    (0, s.Ko)(
                                      ...
                                      (e, i) => (
                                        ...
                                        (0, s.iD)(
                                          ...
                                          {
                                            key: i,
                                            class: (0, l.C_)(e.status ? 'Color' + e.status : ''),
                                            style: (0, l.j5)(e.color ? 'background: #' + e.color : ''),
                                            onClick: (i) => t.taskBtn(e.handle),
                                          },
                                          (0, l.zw)(e.text),
                                          15,
                                  ...
                                  (0, s._)(
                                    ...
                                    {
                                      class: 'MBCancel',
                                      onClick: e[2] || (e[2] = (...e) => t.close && t.close(...e)),
                                    },
                                    (0, l.zw)(t.dataLine.cancel || '取消'),
                                    1
                                  ),
        ...
        const P = (t) => ((0, s.dD)('data-v-5996900d'), (t = t()), (0, s.Cn)(), t),
          H = {
            class: 'MBReultBox',
          },
          q = {
        ...
        let ct = class extends o.w3 {
          ...
          clear() {
            !0 === this.display ? (this.display = !1) : ((this.entity = void 0), (this.dataLine = void 0))
          }
          open(t) {
            ;(this.entity = t),
              (this.dataLine = this.entity.getCurrent()),
          ...
          taskBtn(t) {
            let e
            this.dataLine && this.dataLine.bind && (e = this.$refs['tpl-' + this.dataLine.bind]),
        ...
        let ft = class extends o.w3 {
          ...
          update(t) {
            let e,
              i,
              a = []
            t && ((e = t.sequence.active), (i = t.sequence.alerts[0]), (a = t.sequence.minmizes)),
        ...
        class mt {
          constructor(t) {
            ;(0, a.Z)(this, 'window', void 0), (0, a.Z)(this, 'scope', void 0), (this.window = t)
          }
          render(t) {
            return (!this.scope || this.scope === t.handle) && (this.window.update(t), !0)
          }
          enable(t) {
            ;(this.scope = t.handle), this.render(t)
          }
          disable(t) {
            this.scope == t.handle && ((this.scope = void 0), this.window.update())
          }
        }
        class gt {
          static install() {
            if (window.document) {
              ...
              if (!t) {
                ...
                ;(e.value = 'msgbox'), t.setAttributeNode(e), document.body.appendChild(t)
              }
          ...
          static getString(t = 4) {
            ...
            let i = new Date().getTime(),
              a = ''
            for (let n = 0; n < t; n++) (i += e * n), (a += ((i + 16 * Math.random()) % 16 | 0).toString(16))
            return a
          }
          static getService() {
  ...
  ;(i.m = t),
    ...
    (function () {
      ...
      i.l = function (e, a, n, s) {
        if (t[e]) t[e].push(a)
          ...
          ;(r.onerror = h.bind(null, r.onerror)), (r.onload = h.bind(null, r.onload)), o && document.head.appendChild(r)
        }
      }
    })(),
    (function () {
        ...
        var t = function (t, e, i, a, n) {
            ...
            var r = function (i) {
              if (((s.onerror = s.onload = null), 'load' === i.type)) a()
                ...
                ;(l.code = 'CSS_CHUNK_LOAD_FAILED'), (l.type = r), (l.request = o), s.parentNode.removeChild(s), n(l)
              }
            }
            return (
    ...
    (function () {
      ...
      var e = function (e, a) {
          ...
          for (e && e(a); c < r.length; c++) (s = r[c]), i.o(t, s) && t[s] && t[s][0](), (t[s] = 0)
          return i.O(d)
        },
...
//# sourceMappingURL=app.0cb8ccf7.js.map
